...
<div id="title" class="screen">
  <h1 class="big"> 🗡️ 쳇 RPG 🗡️ </h1>
  <p class="mid">아무 화면이나 터치</p>
</div>

<div id="game" class="screen">
  <div class="top">💰 <span id="gold">0</span> | Lv <span id="lv"></span></div>

  <div class="big">🧝‍♂️</div>
  <div class="mid">전사</div>
...
<div id="shop" class="screen">
  <h2 class="big">🛒 상점</h2>
  <p>골드: <span id="shopGold"></span></p>
  <div id="shopItems"></div>
  <button onclick="next()">➡ 계속</button>
</div>

<div id="levelup" class="screen">
  <h2 class="big">⬆ 레벨업!</h2>
  <button onclick="stat('hp')">❤️ 체력 +30</button>
  <button onclick="stat('atk')">⚔ 공격력 +10</button>
</div>
...
const weapons=[
["철검",5,30],["강철검",10,60],["기사검",15,100],["마검",22,150],["전설검",35,220]
];
...
function spawn(){
 ...
 if(boss){
  enemy={name:"보스 드래곤",emoji:"👑🐉",hp:320,maxHp:300,atk:20};
 }else{
